...
*/}}
{{- define "stalwart-operator.fullname" -}}
...
*/}}
{{- define "stalwart-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "stalwart-operator.resourceName" -}}
{{- $fullname := include "stalwart-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "stalwart-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "stalwart-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
